...
pub const ImVector_ImWchar = struct_ImVector_ImWchar; // cimgui.h:1294:18: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiViewportP = struct_ImGuiViewportP; // cimgui.h:2894:15: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiTableDrawChannelIdx = ImU16; // cimgui.h:3055:10: warning: struct demoted to opaque type - has bitfield
...
pub const ImBitArrayPtr = [*c]ImU32; // cimgui.h:3111:24: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiDockContext = struct_ImGuiDockContext; // cimgui.h:2276:24: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiMetricsConfig = struct_ImGuiMetricsConfig; // cimgui.h:2439:19: warning: struct demoted to opaque type - has bitfield
...
pub const struct_ImGuiContext = extern struct {
    ...
    DragDropTargetClipRect: ImRect = @import("std").mem.zeroes(ImRect),
    ...
    DebugFlashStyleColorBackup: ImVec4 = @import("std").mem.zeroes(ImVec4),
...
pub const ImGuiOnceUponAFrame = struct_ImGuiOnceUponAFrame; // cimgui.h:897:24: warning: struct demoted to opaque type - has bitfield
...
pub const ImGuiInputFlags_RouteExtraMask_: c_int = 196608;
...
pub const ImVector_ImGuiTableColumnSortSpecs = struct_ImVector_ImGuiTableColumnSortSpecs; // cimgui.h:3224:10: warning: struct demoted to opaque type - has bitfield
...
pub extern fn igGetKeyChordName(key_chord: ImGuiKeyChord, out_buf: [*c]u8, out_buf_size: c_int) [*c]const u8;
...
pub const API = @compileError("unable to translate macro: undefined identifier `__visibility__`"); // cimgui.h:17:17
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /home/zak/zig/0.12.0-dev.2341+92211135f/files/lib/include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /home/zak/zig/0.12.0-dev.2341+92211135f/files/lib/include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /home/zak/zig/0.12.0-dev.2341+92211135f/files/lib/include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/zak/zig/0.12.0-dev.2341+92211135f/files/lib/include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/zak/zig/0.12.0-dev.2341+92211135f/files/lib/include/stdarg.h:46:9
