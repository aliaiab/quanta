...
pub fn init(
    ...
    for (descriptor_set_layout_bindings, 0..) |*descriptor_binding, i| {
        ...
        descriptor_binding.stage_flags = .{
            .vertex_bit = true,
            .fragment_bit = true,
        };
    ...
    _ = try Context.self.vkd.createGraphicsPipelines(Context.self.device, Context.self.pipeline_cache, 1, &[_]vk.GraphicsPipelineCreateInfo{.{
        ...
        .p_rasterization_state = &.{
            ...
            .cull_mode = switch (options.rasterisation_state.cull_mode) {
                ...
                .back => vk.CullModeFlags{
                    .back_bit = true,
                },
                .front => vk.CullModeFlags{
                    .front_bit = true,
                },
            },
        ...
        .p_depth_stencil_state = &.{
            .flags = .{},
            .depth_test_enable = @enumFromInt(@intFromBool(options.depth_state.test_enabled)),
            .depth_write_enable = @enumFromInt(@intFromBool(options.depth_state.write_enabled)),
        ...
        .p_color_blend_state = &.{
            ...
            .p_attachments = &[_]vk.PipelineColorBlendAttachmentState{.{
                ...
                .blend_enable = @enumFromInt(@intFromBool(options.blend_state.blend_enabled)),
